...
if bonus == "Yes" or bonus == "yes" or bonus == "YES":
    ...
    test_case = get_bonus_test_case(ReelSet_Normal_1,FS,MP)
    ...
    if times_repeat < 5:
        ...
        next_symbol = None
    start_time = time.time()
    test_case = script_loop(ReelSet_Normal_1, symbol_in_combination,times_repeat,next_symbol)[0]
    best_move = script_loop(ReelSet_Normal_1, symbol_in_combination,times_repeat,next_symbol)[1]
    console_test_case(test_case_name, test_case)
